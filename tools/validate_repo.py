...
ALLOWED_TOP = {".github","00_FOUNDATION","00_CORE","01_CHANNEL","02_PIPELINE","03_VIDEOS","04_SHARED","tools",
               ".claude","channel","topics","videos","weftcut","knowledge"}  # new Claude Code structure from VIDEO_003
...
FOUNDATION_REQUIRED = {
    ...
    "LEGAL_LANGUAGE_LOCKS.md","REVIEW_METRICS.md","BRAND_LOCK.md","VISUAL_LOCK.md","FIRST_10_TOPICS.md","VOICE_LOCK.md"
}
CORE_REQUIRED = {
    ...
    "TOPIC_QUALIFICATION_SCHEMA.md","CHANNEL_OPERATING_MAP.md","CHANNEL_PRELAUNCH_SETUP.md",
    "PREPARATION_BLOCK.md","QUALITY_GATES.md","PRODUCTION_PIPELINE.md","TASK_RECIPES.md","STORAGE_POLICY.md",
